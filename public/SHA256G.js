...
class SHA256G {
    ...
    // Só funciona se a ENTRADA chegar em forma NUMERICA
    /////////////////////////////////////////////////////////////////////////////////////////////       
    static SHA256MsnHxHex2(txtcomp, Hx) {
        const W = [
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
    ...
    // Só funciona se a ENTRADA chegar em forma NUMERICA
    /////////////////////////////////////////////////////////////////////////////////////////////       
    static SHA256MsnHxHex3(txtcomp, Hx) {
        const W = [
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
        ...
        let result = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    // Só funciona se a ENTRADA chegar em forma NUMERICA
    /////////////////////////////////////////////////////////////////////////////////////////////       
    static SHA256MsnHx(txtcompSTR, HxSTR) {
        const W = [
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
            0x00000000n, 0x00000000n, 0x00000000n, 0x00000000n,
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////       
    static HashStrToByte2(hashKey) {
        const result = new Array(hashKey.length);
        const result2 = new Array(hashKey.length / 2);
